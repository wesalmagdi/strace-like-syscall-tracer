...
user/_execchaintest:     file format elf64-littleriscv
...
main(void)
{
  ...
  char *argv[] = { "execchain_b", 0 };
   ...
   e:	8c648493          	addi	s1,s1,-1850 # 8d0 <malloc+0x104>
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 3c4:	52850513          	addi	a0,a0,1320 # 8e8 <digits>
 3c8:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 662:	28ab8b93          	addi	s7,s7,650 # 8e8 <digits>
 ...
 6c4:	22090913          	addi	s2,s2,544 # 8e0 <malloc+0x114>
        for(; *s; s++)
