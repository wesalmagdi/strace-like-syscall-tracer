...
0000000000000380 <set_interruptible>:
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 666:	276b8b93          	addi	s7,s7,630 # 8d8 <digits>
 ...
 6c8:	20c90913          	addi	s2,s2,524 # 8d0 <malloc+0x100>
        for(; *s; s++)
