...
00000000000003bc <set_interruptible>:
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 404:	55050513          	addi	a0,a0,1360 # 950 <digits>
 408:	883a                	mv	a6,a4
