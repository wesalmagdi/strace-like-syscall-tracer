...
user/_bgtest:     file format elf64-littleriscv
...
main(void)
{
  ...
  12:	8b250513          	addi	a0,a0,-1870 # 8c0 <malloc+0xfc>
  16:	6fa000ef          	jal	710 <printf>

  while(1){
    getpid();
  1a:	322000ef          	jal	33c <getpid>
    pause(1);
  1e:	4505                	li	a0,1
  20:	32c000ef          	jal	34c <pause>
  while(1){
  24:	bfdd                	j	1a <main+0x1a>
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 65a:	282b8b93          	addi	s7,s7,642 # 8d8 <digits>
