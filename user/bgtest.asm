...
main(void)
{
  ...
  12:	8a250513          	addi	a0,a0,-1886 # 8b0 <malloc+0x104>
  16:	6e2000ef          	jal	6f8 <printf>
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 3a4:	52850513          	addi	a0,a0,1320 # 8c8 <digits>
 3a8:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 6a4:	22090913          	addi	s2,s2,544 # 8c0 <malloc+0x114>
        for(; *s; s++)
