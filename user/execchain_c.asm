...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 636:	855a                	mv	a0,s6
 638:	d37ff0ef          	jal	36e <putc>
  putc(fd, 'x');
 63c:	07800593          	li	a1,120
 640:	855a                	mv	a0,s6
 642:	d2dff0ef          	jal	36e <putc>
 646:	4941                	li	s2,16
