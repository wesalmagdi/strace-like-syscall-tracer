...
main(void)
{
  ...
  write(1, "A", 1);      // no newline on purpose
   ...
   e:	8c658593          	addi	a1,a1,-1850 # 8d0 <malloc+0x104>
  12:	4505                	li	a0,1
  ...
  22:	8ba58593          	addi	a1,a1,-1862 # 8d8 <malloc+0x10c>
  26:	4505                	li	a0,1
  ...
  36:	8ae58593          	addi	a1,a1,-1874 # 8e0 <malloc+0x114>
  3a:	4505                	li	a0,1
