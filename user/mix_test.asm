...
main(void)
{
  ...
  write(1, "A", 1);      // no newline on purpose
   ...
   e:	8d658593          	addi	a1,a1,-1834 # 8e0 <malloc+0xfc>
  12:	4505                	li	a0,1
  ...
  22:	8ca58593          	addi	a1,a1,-1846 # 8e8 <malloc+0x104>
  26:	4505                	li	a0,1
  ...
  36:	8be58593          	addi	a1,a1,-1858 # 8f0 <malloc+0x10c>
  3a:	4505                	li	a0,1
