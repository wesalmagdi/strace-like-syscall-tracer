...
user/_mix_test:     file format elf64-littleriscv
...
main(void)
{
  ...
  write(1, "A", 1);      // no newline on purpose
   ...
   e:	8e658593          	addi	a1,a1,-1818 # 8f0 <malloc+0x104>
  12:	4505                	li	a0,1
  14:	2e8000ef          	jal	2fc <write>
  getpid();              // trace line may appear beside A
  18:	344000ef          	jal	35c <getpid>

  write(1, "B", 1);      // no newline on purpose
  1c:	4605                	li	a2,1
  1e:	00001597          	auipc	a1,0x1
  22:	8da58593          	addi	a1,a1,-1830 # 8f8 <malloc+0x10c>
  26:	4505                	li	a0,1
  28:	2d4000ef          	jal	2fc <write>
  getpid();              // trace line may appear beside B
  2c:	330000ef          	jal	35c <getpid>

  write(1, "\nDONE\n", 6);
  30:	4619                	li	a2,6
  32:	00001597          	auipc	a1,0x1
  36:	8ce58593          	addi	a1,a1,-1842 # 900 <malloc+0x114>
  3a:	4505                	li	a0,1
  3c:	2c0000ef          	jal	2fc <write>

  exit(0);
  40:	4501                	li	a0,0
  42:	29a000ef          	jal	2dc <exit>
...
strlen(const char *s)
{
  ...
  b8:	ff65                	bnez	a4,b0 <strlen+0x10>
  ba:	40a6853b          	subw	a0,a3,a0
  be:	2505                	addiw	a0,a0,1
    ;
  return n;
}
  c0:	6422                	ld	s0,8(sp)
...
stat(const char *n, struct stat *st)
{
 ...
 198:	84aa                	mv	s1,a0
  ...
  r = fstat(fd, st);
 19a:	85ca                	mv	a1,s2
 19c:	198000ef          	jal	334 <fstat>
 1a0:	892a                	mv	s2,a0
  close(fd);
 1a2:	8526                	mv	a0,s1
 1a4:	160000ef          	jal	304 <close>
  return r;
 1a8:	64a2                	ld	s1,8(sp)
}
 1aa:	854a                	mv	a0,s2
...
memmove(void *vdst, const void *vsrc, int n)
{
 ...
 222:	fed70fa3          	sb	a3,-1(a4)
    while(n-- > 0)
 226:	fef71ae3          	bne	a4,a5,21a <memmove+0x18>
    src += n;
    while(n-- > 0)
      *--dst = *--src;
  }
...
000000000000038c <set_trace_output>:
...
000000000000039c <set_interruptible>:
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 3e4:	53050513          	addi	a0,a0,1328 # 910 <digits>
 3e8:	883a                	mv	a6,a4
